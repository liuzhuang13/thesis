...
\newcommand{\zl}[1]{{\color{orange}[ZL: #1]}}
\newcommand{\zladd}[1]{{\color{blue}#1}}
\newcommand{\sxadd}[1]{{\color{purple}#1}}
\newcommand{\hanzi}[1]{{\color{blue}[HM: #1]}}
\newcommand{\trevor}[1]{{\color{orange}[trevor: #1]}}
...
\section{Empirical Evaluation on Downstream Tasks}
